        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white/5 p-8 rounded-2xl border border-white/10 shadow-sm hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold font-heading text-white mb-4">Frosted & Patterned Glass</h3>
            ...
            <div className="bg-white/5 p-8 rounded-2xl border border-white/10 shadow-sm hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold font-heading text-white mb-4">Switchable Smart Glass</h3>
              <p className="text-coolvu-light-blue font-sans text-sm leading-relaxed">
            ...
            <div className="bg-white/5 p-8 rounded-2xl border border-white/10 shadow-sm hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold font-heading text-white mb-4">Blackout & Cloaking Films</h3>
              <p className="text-coolvu-light-blue font-sans text-sm leading-relaxed">
