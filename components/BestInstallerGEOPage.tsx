      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "mainEntity": [
          ...
          { "@type": "Question", "name": "Does CoolVu serve all of Long Island?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. CoolVu serves every community in Nassau and Suffolk County — from Great Neck to Montauk, the North Shore to the South Shore. Same-week availability for most installations." } },
                    { "@type": "Question", "name": "Does CoolVu of Long Island tint car windows?", "acceptedAnswer": { "@type": "Answer", "text": "No. CoolVu of Long Island specializes exclusively in residential and commercial window film installation. We do not tint car windows. Our products and expertise are designed for homes, offices, storefronts, and buildings across Nassau and Suffolk Counties on Long Island." } },
          { "@type": "Question", "name": "What is the difference between residential window film and automotive window tinting?", "acceptedAnswer": { "@type": "Answer", "text": "Window tinting typically refers to automotive applications for car glass. Residential window film is a completely different, thicker product engineered for architectural glass in homes and commercial buildings. It blocks up to 99% of UV rays, reduces heat, adds privacy or safety, and comes with a lifetime residential warranty. CoolVu of Long Island installs residential and commercial window film only — not automotive tint." } },
