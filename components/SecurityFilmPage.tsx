        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-coolvu-off-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold font-heading text-coolvu-dark-blue mb-4">DefenseLite® Panels</h3>
            ...
            <div className="bg-coolvu-off-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold font-heading text-coolvu-dark-blue mb-4">BulletShield™</h3>
              <p className="text-gray-600 font-sans text-sm leading-relaxed">
            ...
            <div className="bg-coolvu-off-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold font-heading text-coolvu-dark-blue mb-4">Safety & Anti-Shatter Film</h3>
              <p className="text-gray-600 font-sans text-sm leading-relaxed">
