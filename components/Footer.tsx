...
export default function Footer() {
  ...
  return (
    <footer className="bg-coolvu-dark-blue pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl p-8 md:p-12 flex flex-col items-center gap-10 text-coolvu-dark-blue shadow-xl">
