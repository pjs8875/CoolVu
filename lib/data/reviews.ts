...
export const REVIEWS: CustomerReview[] = [
  ...
  { name: "Donna Cosel-Pieper", town: "East Hampton", rating: 5, text: "Our house in East Hampton faces west and has no shade on that side. I called Paul after seeing his reviews online. He answered the phone and gave me information on the solar film product they use on windows. I was very skeptical about the claims of its effectiveness, but now I am shocked by how much it reduces the heat coming through the windows! Paul was a pleasure to deal with, as was Manny, who came very quickly to do the installation." },
  ...
  { name: "Diana Waldron", town: "Westhampton Beach", rating: 5, text: "CoolVu recently replaced old solar panels and added additional panels to windows at my home in Westhampton Beach. The two workers did an excellent job and were courteous and very neat. I am very pleased with the work." },
];
